...
@Module({
  ...
  providers: [
    ...
    {
      provide: ListMovieScheduleQueryHandler,
      useFactory: (movieQuery: MovieQueryPort) => new ListMovieScheduleQueryHandler(movieQuery),
      inject: [MOVIE_QUERY],
    },
    {
    ...
    },
    {
      ...
      useFactory: (
        ...
        listMovieScheduleQueryHandler: ListMovieScheduleQueryHandler,
        listAdminMoviesQueryHandler: ListAdminMoviesQueryHandler,
        listTheatersQueryHandler: ListTheatersQueryHandler,
        listTheaterScheduleQueryHandler: ListTheaterScheduleQueryHandler,
        ...
        QueryBus.of([
          ...
          { query: ListMovieScheduleQuery, handler: listMovieScheduleQueryHandler },
          { query: ListAdminMoviesQuery, handler: listAdminMoviesQueryHandler },
          { query: ListTheatersQuery, handler: listTheatersQueryHandler },
          { query: ListTheaterScheduleQuery, handler: listTheaterScheduleQueryHandler },
